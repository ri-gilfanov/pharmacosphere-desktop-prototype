...
class PriceTab(StandartTab):
    def __init__(self, basis):
        ...
        self.tv['columns'] = ['manufacturer', 'price', 'date']
        ...
        self.tv.column('manufacturer', minwidth=125, stretch=True, width=250)
        self.tv.column('price', anchor='e', minwidth=125, stretch=True, width=250)
        self.tv.column('date', anchor='c', minwidth=125, stretch=True, width=250)
    ...
    def update(self, requestList=None):
        ...
        for rec in self.db.data['price_list']:
            ...
            if strItmCode in tagParents:
                ...
                value = (mnfName, strPrice, rec['date'])
                self.tv.insert(
                    parent=strItmCode,
                    index='end',
                    iid=code,
